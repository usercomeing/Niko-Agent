...
def test_async_worker_notification_is_drained_by_coordinator_only(tmp_path):
    ...
    # Windows process and filesystem startup is noisier; this still proves the
    # coordinator returns without waiting for the blocked child to complete.
...
def test_plan_mode_allows_only_explore_agents(tmp_path):
    agent = build_agent(
        ...
        [
            ...
            '<tool name="write_file" path=".niko/plans/gate7-plan.md"><content># Gate7\n</content></tool>',
