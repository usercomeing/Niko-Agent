...
SKILL_FILE_CREATION_GUIDE = """When creating Niko skill files at .niko/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${NIKO_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".niko" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".niko" / "skills", "project"),
    ]
